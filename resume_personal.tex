...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \vspace{-10pt}
      \resumeSubSubheading
        {Senior Cloud Engineer}{2024 -- Present}
      \resumeItemListStart
...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    {Computer Science Programming/Networking - Walters State Comm. College}{2009 -- 2012}
...
\section{Additional Activities}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Mentorship}{}
      {Helping mentees navigate the challenges of public cloud concepts, build confidence, sparring and work/life balance.}{}
  \resumeSubHeadingListEnd
%-------------------------------------------
\end{document}
